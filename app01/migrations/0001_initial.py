# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2022-11-29 18:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bolg', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.Blog')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_down', models.BooleanField(verbose_name='是否点踩')),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Article')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
